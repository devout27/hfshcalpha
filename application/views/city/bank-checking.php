...
<div class="container-fluid">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-priority="3"><?= $check['bank_checks_status'] ?></td>
      <td data-priority="1">
		<form method="post" action="/city/bank/process_check/<?= $check['bank_checks_id'] ?>">
		<div class="row">
			<div class="col-lg-12">
				<?= hf_dropdown('action', '', '', array('deposit' => 'Deposit ', 'ignore' => 'Ignore', 'refuse' => 'Refuse'), array('class' => 'col-sm-12'), $errors) ?>
			</div>
			<div class="col-lg-12">
				<?= hf_submit('process_check', 'Process', array('class' => 'btn btn-primary col-sm-12')) ?>
			</div>
		</div>
		</form>
      </td>
      ...
      <div class="col-sm-6 col-md-6">
          ...
          <?= hf_dropdown('bank_tier', '', $account, array('A','B','C','D','E','F'), null, $errors, 1, 0) ?>
    		...
    		<div class="col-sm-6 col-md-3">
				<?= hf_dropdown('bank_default', 'Make Default Account?', $account ?: $post, array('0' => 'No', '1' => 'Yes'), array(), $errors, 0, 0) ?>
			</div>

  ...
  <table class="table table-sm table-hover" id="dt-appts-<?= $title ?>">
    ...
    <tbody>
      ...
      <?= $horse['horse_appointments_date'] ?>
        ...
        <td>
          <form method="post" action="/city/vet/action">
    ...
    <form method="post" action="/city/vet/action" id="perform_appts_form">
      <input type="hidden" name="perform_appts" id="perform_appts" value="" required>
      <div class="text-center">
        <button class="btn btn-primary">Perform Appt</button>
      </div>
    </form>
</div>
         ...
         <div class="card-box-area-inner">
            ...
            <div class="container h-100 py-2">
               <ul class="nav nav-tabs nav-fill border-0" id="myTab" role="tablist">
                  ...
                  <li class="nav-item">
                     <a class="nav-link <?= count($errors) > 0 ? 'active' : '' ?> border border-muted border-bottom-0" id="edittab" data-toggle="tab" href="#edit-tab" role="tab" aria-controls="edit-tab" aria-selected="false">Edit Account</a>
                  </li>
               </ul>
